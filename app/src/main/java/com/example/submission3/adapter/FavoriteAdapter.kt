...
import com.example.submission3.databinding.RowItemfavoritesBinding
import com.example.submission3.model.Item
import com.example.submission3.ui.favorites.FavoritesFragmentDirections
    ...
    class MyViewHolder(val binding: RowItemfavoritesBinding) :
        ...
        fun bind(favoritesUser: Item) {
            ...
            binding.cvFavorite.setOnClickListener {
                val action =
                    FavoritesFragmentDirections.actionNavigationFavoritesToUserDetailFragment(
                        favoritesUser
                    )
